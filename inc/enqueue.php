...
function mei_enqueue_styles() {
	$pages = array(
		'employee','registration','general-overview','key-news','latest-project'
	);

	if(is_page( $pages )):
	wp_enqueue_style( 'bootstrap1', get_stylesheet_directory_uri() . '/assets/css/bootstrap1.min.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'themify', get_stylesheet_directory_uri() . '/assets/vendors/themefy_icon/themify-icons.css', false, 'TETCHNODEMO_VER', 'all');
	// wp_enqueue_style( 'nice-select', get_stylesheet_directory_uri() . '/assets/vendors/niceselect/css/nice-select.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'select2', get_stylesheet_directory_uri() . '/assets/vendors/select2/css/select2.min.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'owl.carousel', get_stylesheet_directory_uri() . '/assets/vendors/owl_carousel/css/owl.carousel.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'gijgo', get_stylesheet_directory_uri() . '/assets/vendors/gijgo/gijgo.min.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'all.min', get_stylesheet_directory_uri() . '/assets/vendors/font_awesome/css/all.min.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'tagsinput', get_stylesheet_directory_uri() . '/assets/vendors/tagsinput/tagsinput.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'date-picker', get_stylesheet_directory_uri() . '/assets/vendors/datepicker/date-picker.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'vectormap', get_stylesheet_directory_uri() . '/assets/vendors/vectormap-home/vectormap-2.0.2.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'scrollable', get_stylesheet_directory_uri() . '/assets/vendors/scroll/scrollable.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'jquery.dataTables', get_stylesheet_directory_uri() . '/assets/vendors/datatable/css/jquery.dataTables.min.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'responsive.dataTables', get_stylesheet_directory_uri() . '/assets/vendors/datatable/css/responsive.dataTables.min.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'buttons.dataTable', get_stylesheet_directory_uri() . '/assets/vendors/datatable/css/buttons.dataTables.min.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'summernote', get_stylesheet_directory_uri() . '/assets/vendors/text_editor/summernote-bs4.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'morris', get_stylesheet_directory_uri() . '/assets/vendors/morris/morris.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'material-icons', get_stylesheet_directory_uri() . '/assets/vendors/material_icon/material-icons.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'sweetalert', get_stylesheet_directory_uri() . '/assets/vendors/sweetalert/css/sweetalert.css', false, 'TETCHNODEMO_VER', 'all');

	wp_enqueue_style( 'metisMenu', get_stylesheet_directory_uri() . '/assets/css/metisMenu.css', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'style1', get_stylesheet_directory_uri() . '/assets/css/style1.css"', false, 'TETCHNODEMO_VER', 'all');
	wp_enqueue_style( 'default', get_stylesheet_directory_uri() . '/assets/css/colors/default.css', false, 'TETCHNODEMO_VER', 'all');
...
// function list_all_enqueued_scripts() {
//     global $wp_scripts;
...
//     }
// }
// add_action('wp_footer', 'list_all_enqueued_scripts');



// function disable_inline_css_start() {
//     // Check if we are on the specific page. Replace 'your-page-slug' with your page's slug.
//     if (is_page('employee')) {
//         ob_start('elementor-frontend-inline-css');
//     }
// }
// add_action('wp_head', 'disable_inline_css_start', 1);

// function disable_elementor_css_on_specific_page() {
//     // Check if we are on the specific page. Replace 'your-page-slug' with your page's slug.
//     if (is_page('general-overview')) {
//         // Dequeue the Elementor frontend CSS
//         wp_dequeue_style('elementor-frontend-css');
//     }
// }
// add_action('wp_enqueue_scripts', 'disable_elementor_css_on_specific_page', 20); // Use a priority of 20 or higher
