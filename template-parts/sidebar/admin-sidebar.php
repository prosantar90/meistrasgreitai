<nav class="sidebar">
		...
		<ul id="sidebar_menu">
			...
			<li class>
				...
				<ul>
					<li><a href="<?= home_url( 'signed-contracts');?>">Signed Contracts</a></li>
			...
			<li class>
				<a href="<?= home_url('partneriu-sarasas');?>" aria-expanded="false">
					<div class="nav_icon_small">
						<img src="<?= get_stylesheet_directory_uri();?>/assets/img/menu-icon/users.svg" alt>
					</div>
					<div class="nav_title">
